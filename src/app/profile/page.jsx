...
export default function Profile() {
    ...
    return (
        <main>
            ...
            {
                influencer ?
                <div className="flex flex-col md:flex-row justify-center my-4 mx-2 md:mx-[10%] shadow-md bg-white rounded-lg p-8 relative">

                    {/* Edit Button */}
                    <button onClick={() => router.push(`/profile/edit-profile?inf_id=${influencer.id}`)}
                    className="absolute border border-orange-500 top-10 right-10 bg-white rounded-full w-10 h-10 p-2 flex items-center justify-center hover:bg-gray-200">
