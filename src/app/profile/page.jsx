...
export default function Profile() {
    ...
    const influencer = {
        ...
        bio: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate itaque optio ducimus tenetur sunt, illum, architecto aperiam eos ipsa voluptatem cumque odit excepturi aliquid nesciunt voluptate accusamus minima. Deleniti, qui!",
        followers: 1000,
        posts: 1000,
        ...
        instagram_link: "https://www.instagram.com/janedoe/"
    }
                    ...
                    <div id="categories" className="mb-4">
                        {
                            influencer.categories.map((category, index) => (
                                <span key={index} className="bg-orange-300 rounded-full text-sm py-0.5 px-2 mr-1">{category}</span>
                            ))
                        }
                    </div>
